...
-- nvim-tree shortcuts
-- toggle tree
vim.keymap.set('n', '<Leader>t', function() ntree.tree.toggle() end)

-- tab management shortcuts
vim.keymap.set('n', '<Leader><Left>', '<cmd>tabprevious<cr>')
vim.keymap.set('n', '<Leader><Right>', '<cmd>tabnext<cr>')
...
-- Termdebug settings
-- Always load termdebug for debugging
vim.cmd [[packadd termdebug]]

-- evaluate expression under cursor
vim.keymap.set('n', '<Leader>de', '<cmd>:Evaluate<cr>')

local init_cmds = vim.api.nvim_create_augroup('init commands', { clear = true })
-- Open file tree after entering new tab
